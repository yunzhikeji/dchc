...
public class GuiltSafeguardManDaoImp implements GuiltSafeguardManDao {
	...
	//保存一条记录
	/* (non-Javadoc)
	 * @see com.yz.dao.imp.GuiltSafeguardManDao#save(com.yz.model.GuiltSafeguardMan)
	 */
	...
	//保存一条记录
	/* (non-Javadoc)
	 * @see com.yz.dao.imp.GuiltSafeguardManDao#savereturn(com.yz.model.GuiltSafeguardMan)
	 */
	...
	//删除一条记录
	/* (non-Javadoc)
	 * @see com.yz.dao.imp.GuiltSafeguardManDao#delete(com.yz.model.GuiltSafeguardMan)
	 */
	...
	//根据ID删除一条记录
	/* (non-Javadoc)
	 * @see com.yz.dao.imp.GuiltSafeguardManDao#deleteById(int)
	 */
	...
	//修改一条记录
	/* (non-Javadoc)
	 * @see com.yz.dao.imp.GuiltSafeguardManDao#update(com.yz.model.GuiltSafeguardMan)
	 */
	...
	/* (non-Javadoc)
	 * @see com.yz.dao.imp.GuiltSafeguardManDao#updateByHql(java.lang.String, java.lang.String[], java.lang.Object[])
	 */
	...
	//获得所有记录
	/* (non-Javadoc)
	 * @see com.yz.dao.imp.GuiltSafeguardManDao#getGuiltSafeguardMans()
	 */
	...
	//根据hql语句来查询所有记录
	/* (non-Javadoc)
	 * @see com.yz.dao.imp.GuiltSafeguardManDao#queryList(java.lang.String)
	 */
	...
	//根据hql、条件值查询某些记录
	/* (non-Javadoc)
	 * @see com.yz.dao.imp.GuiltSafeguardManDao#getObjectsByCondition(java.lang.String, java.lang.Object[])
	 */
	...
	/* (non-Javadoc)
	 * @see com.yz.dao.imp.GuiltSafeguardManDao#queryList(java.lang.String, java.lang.String[], java.lang.Object[])
	 */
	...
	//根据hql、id列表查询某些记录
	/* (non-Javadoc)
	 * @see com.yz.dao.imp.GuiltSafeguardManDao#getObjectsByIdList(java.lang.String, java.util.List)
	 */
	...
	/* (non-Javadoc)
	 * @see com.yz.dao.imp.GuiltSafeguardManDao#pageList(java.lang.String, java.lang.Object[], java.lang.Integer, java.lang.Integer)
	 */
	...
	//根据hql、条件值获得一个唯一值
	/* (non-Javadoc)
	 * @see com.yz.dao.imp.GuiltSafeguardManDao#getUniqueResult(java.lang.String, java.lang.Object[])
	 */
	...
	//根据id查询一条记录
	/* (non-Javadoc)
	 * @see com.yz.dao.imp.GuiltSafeguardManDao#loadById(int)
	 */
	...
	//根据hql语句、条件、值来查询一条记录
	/* (non-Javadoc)
	 * @see com.yz.dao.imp.GuiltSafeguardManDao#queryByNamedParam(java.lang.String, java.lang.String[], java.lang.Object[])
	 */
	...
	/* (non-Javadoc)
	 * @see com.yz.dao.imp.GuiltSafeguardManDao#checkGuiltSafeguardManExistsWithName(java.lang.String, java.lang.Object[])
	 */
	...
	//根据hql批量修改
	/* (non-Javadoc)
	 * @see com.yz.dao.imp.GuiltSafeguardManDao#updateGuiltSafeguardManByhql(java.lang.String, java.lang.Object[])
	 */
