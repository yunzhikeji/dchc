...
public class PersonDaoImp implements IPersonDao {
	 ...
	 */
	public Integer savereturn(Person person) {
		return (Integer) this.hibernateTemplate.save(person);
	}
	 ...
	 */
	public List<Person> queryList(String queryString) {
	 ...
	 */
	public List<Person> getObjectsByCondition(String queryString, Object[] p) {
	 ...
	 */
	public List<Person> queryList(String queryString, String[] paramNames,
			Object[] values)
	{
	 ...
	 */
	public List<Person> getObjectsByIdList(final String hql,final List<Integer> idList) {
	 ...
	 */
	public List<Person> pageList(final String queryString,final Object[] p,final Integer page,
			final Integer size) {
		return this.hibernateTemplate.executeFind(new HibernateCallback(){
	 ...
	 */
	public Person queryByNamedParam(String queryString, String[] paramNames,
			Object[] values) {
		List list=this.hibernateTemplate.findByNamedParam(queryString, paramNames, values);
	 ...
	 */
	public boolean checkPersonExistsWithName(String queryString, Object[] p) {
	 ...
	 */
	public int updatePersonByhql(String queryString, Object[] p) {
		Session session=this.hibernateTemplate.getSessionFactory().getCurrentSession();
		Query query= session.createQuery(queryString);
		if(p!=null&&p.length>0){
			for (int i = 0; i < p.length; i++) {
