...
@Component("pnoticeDao")
public class PnoticeDaoImp implements IPnoticeDao {
	 ...
	 */
	public void save(Pnotice pnotice) {
		this.hibernateTemplate.save(pnotice);
	}
	 ...
	 */
	public Integer savereturn(Pnotice pnotice) {
		return (Integer) this.hibernateTemplate.save(pnotice);
	}
	...
	public void delete(Pnotice pnotice) {
		this.hibernateTemplate.delete(pnotice);
	}
	//根据ID删除一条记录
	/* (non-Javadoc)
	...
	public void update(Pnotice pnotice) {
		this.hibernateTemplate.update(pnotice);
	}
	...
	public List<Pnotice> getPnotices() {
		return this.hibernateTemplate.loadAll(Pnotice.class);
	}
	 ...
	 */
	public List<Pnotice> queryList(String queryString) {
	 ...
	 */
	public List<Pnotice> getObjectsByCondition(String queryString, Object[] p) {
	 ...
	 */
	public List<Pnotice> queryList(String queryString, String[] paramNames,
			Object[] values)
	{
	 ...
	 */
	public List<Pnotice> getObjectsByIdList(final String hql,final List<Integer> idList) {
	 ...
	 */
	public List<Pnotice> pageList(final String queryString,final Object[] p,final Integer page,
			final Integer size) {
		return this.hibernateTemplate.executeFind(new HibernateCallback(){
	...
	public Pnotice loadById(int id) {
		return (Pnotice) this.hibernateTemplate.load(Pnotice.class, id);
	}
	 ...
	 */
	public Pnotice queryByNamedParam(String queryString, String[] paramNames,
			Object[] values) {
		List list=this.hibernateTemplate.findByNamedParam(queryString, paramNames, values);
		return list.size()>0?(Pnotice)list.get(0):null;
	}
	 ...
	 */
	public boolean checkPnoticeExistsWithName(String queryString, Object[] p) {
	 ...
	 */
	public int updatePnoticeByhql(String queryString, Object[] p) {
		Session session=this.hibernateTemplate.getSessionFactory().getCurrentSession();
		Query query= session.createQuery(queryString);
		if(p!=null&&p.length>0){
			for (int i = 0; i < p.length; i++) {
	...
	public Pnotice getPnoticeById(Integer uppnoticeid) {
		...
		return (Pnotice) this.hibernateTemplate.get(Pnotice.class, uppnoticeid);
	}
