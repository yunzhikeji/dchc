...
public class GamblingCriminalManDaoImp implements IGamblingCriminalManDao {
	...
	public GamblingCriminalMan queryByNamedParam(String queryString, String[] paramNames,
			Object[] values) {
		List list=this.hibernateTemplate.findByNamedParam(queryString, paramNames, values);
		return list.size()>0?(GamblingCriminalMan)list.get(0):null;
	}
	...
	public GamblingCriminalMan getGamblingCriminalManById(Integer upgamblingCriminalManid) {
		...
		return (GamblingCriminalMan) this.hibernateTemplate.get(GamblingCriminalMan.class, upgamblingCriminalManid);
	}
