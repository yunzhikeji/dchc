...
public interface IGuiltSafeguardManService {

	//添加对象
	public abstract void add(GuiltSafeguardMan guiltSafeguardMan) throws Exception;
	...
	//后台管理-获取符合条件的记录
	public abstract List<GuiltSafeguardMan> queryList(int con, String convalue,UserRole user, int page,
