...
//	}
	 ...
	 */
	public List<AnalyzeMan> queryList(int con, String convalue, UserRole userRole, int page, int size,int type, int queryState, String starttime, String endtime) {
	...
	public AnalyzeMan getAnalyzeManById(Integer upanalyzeManid) {
		// TODO Auto-generated method stub
		return analyzeManDao.getAnalyzeManById(upanalyzeManid);
	}
}
