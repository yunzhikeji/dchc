...
public class PersonServiceImp extends RoleServiceImp implements PersonService {
	...
	public boolean savePersonWithExcel(File file, UserRole userRole, int type) {
		try {
			...
			String pids = "";
			if (type == 11) {
				arrayList = generate.generateStation(file);
				for (int i = 0; arrayList != null && i < arrayList.size(); i++) {
					...
					/*
					 * "人员编号", "姓名", "外文姓名", "别名", "民族", "性别", "出生日期","办案单位","办案人",  "身份证号",
					...
					person.setAppraiserUnitName(data[7].toString());
					person.setAppraiser(data[8].toString());
					person.setIdcard(data[9].toString());
					person.setRegisterAddress(data[10].toString());
					disappearMan.setOtherIdname(data[11].toString());
					disappearMan.setOtherIdnumber(data[12].toString());
					disappearMan.setUnitContactName(data[13].toString());
					disappearMan.setUnitContactTelphone(data[14].toString());
					disappearMan.setReportContactName(data[15].toString());
					disappearMan.setReportContactTelphone(data[16].toString());
					disappearMan.setCurrentAddress(data[17].toString());
					disappearMan.setMissingAddress(data[18].toString());
					disappearMan.setMissingStartTime(data[19].toString());
					disappearMan.setFoundMissingTime(data[20].toString());
					disappearMan.setMissingCause(data[21].toString());
					disappearMan.setHeight(data[22].toString());
					disappearMan.setShape(data[23].toString());
					disappearMan.setFeature(data[24].toString());
					disappearMan.setFootLength(data[25].toString());
					disappearMan.setBloodType(data[26].toString());
					disappearMan.setAccent(data[27].toString());
					disappearMan.setSpecificFeature(data[28].toString());
					disappearMan.setBodyFeature(data[29].toString());
					disappearMan.setSpecificFeatureCon(data[30].toString());
					disappearMan.setDressSituation(data[31].toString());
					disappearMan.setRelativeBlood(data[32].toString());
					person.setRemark(data[33].toString());
					person.setCarrier(data[34].toString());
					person.setCarryTool(data[35].toString());
					disappearMan.setRevocateUnit(data[36].toString());
					disappearMan.setRevocateName(data[37].toString());
					disappearMan.setRevocateTime(data[38].toString());
					disappearMan.setRevocateReason(data[39].toString());
					person.setComprehensiveJudge(data[40].toString());
					person.setLeaderInstruction(data[41].toString());
					person.setType(type);

					String handleStateString = data[42].toString();
					...
					if (data[41] != null && data[43].toString() != null
							&& data[41].toString().trim() != "") {
						String endSituation = data[43].toString();
				...
				for (int i = 0; arrayList != null && i < arrayList.size(); i++) {
					...
					// "人员编号","姓名","性别","出生日期","办案单位","办案人","QQ","微信号","身份证号","手机号码","户籍地详址","户籍地区划","DNA编号","其他身份信息","指纹编号","足迹编号","现住地区划","现住地详址","虚拟身份","银行卡信息","绰号","车牌号","发动机号","车架号","手机串号","人员备注信息","携带物品","携带工具","人员分类","办理状态","民族","录入时间"
					person.setNumber(data[0].toString());
					person.setName(data[1].toString());
					...
					person.setAppraiserUnitName(data[4].toString());
					person.setAppraiser(data[5].toString());
					person.setQq(data[6].toString());
					person.setWechat(data[7].toString());
					person.setIdcard(data[8].toString());
					person.setTelphone(data[9].toString());
					person.setRegisterAddress(data[10].toString());
					person.setRegisterAddressArea(data[11].toString());
					
					if (data[28].toString().contains("赌博")) {
						person.setType(1);
					} else if (data[28].toString().contains("涉恶")) {
						person.setType(2);
					} else if (data[28].toString().contains("涉黄")) {
						person.setType(3);
					} else if (data[28].toString().contains("食药环")) {
						person.setType(4);
					} else if (data[28].toString().contains("涉毒")) {
						person.setType(5);
					} else if (data[28].toString().contains("留置盘问")) {
						person.setType(6);
					} else if (data[28].toString().contains("侵财人员")) {
						person.setType(7);
					} else if (data[28].toString().contains("刑事传唤")) {
						person.setType(8);
					} else if (data[28].toString().contains("负案在逃")) {
						person.setType(9);
					} else if (data[28].toString().contains("维稳人员")) {
						person.setType(10);
					} else if (data[28].toString().contains("失踪")) {
						person.setType(11);
					} else if (data[28].toString().contains("侵财分析")) {
						person.setType(12);
					} else if (data[28].toString().contains("技术比中")) {
						person.setType(13);
					} else if (data[28].toString().contains("前科")) {
						person.setType(14);
					} else if (data[28].toString().contains("其他")) {
						person.setType(15);
					}else
					{
						person.setType(15);
					...
					switch (person.getType()) {
						...
						case 15:
							...
							gamblingCriminalMan.setDnanumber(data[12].toString());
							gamblingCriminalMan.setOtherId(data[13].toString());
							gamblingCriminalMan.setFingerPrintNumber(data[14].toString());
							gamblingCriminalMan.setFootPrintNumber(data[15].toString());
							gamblingCriminalMan.setCurrentAddressArea(data[16].toString());
							gamblingCriminalMan.setCurrentAddress(data[17].toString());
							gamblingCriminalMan.setVirtualId(data[18].toString());
							gamblingCriminalMan.setBankCard(data[19].toString());
							gamblingCriminalMan.setNickname(data[20].toString());
							gamblingCriminalMan.setCarLicenseNumber(data[21].toString());
							gamblingCriminalMan
									.setEngineNumber(data[22].toString());
							gamblingCriminalMan.setCarFrameNumber(data[23].toString());
							gamblingCriminalMan.setImei(data[24].toString());
					...
					person.setRemark(data[25].toString());
					person.setCarrier(data[26].toString());
					person.setCarryTool(data[27].toString());
					...
					String handleStateString = data[29].toString();
					if (handleStateString.contains("未")) {
						person.setHandleState(1);
					} else if (handleStateString.contains("在")) {
						person.setHandleState(2);
			...
			changeUnitPidsByUserRoleAndIdsOperator(userRole, new IdsOperator(pids + "", 1));
	...
	public ArrayList getExcelFieldDataList(int con, String convalue,
		...
		for (int i = 0; personList != null && i < personList.size(); i++) {
			...
			if (type == 11) {
				 ...
				 * "撤销日期", "撤销原因", "综合情况", "领导批示","办理状态","完结情况","人员分类","录入时间"
				 */
				...
				dataList.add(person.getAppraiserUnitName());
				dataList.add(person.getAppraiser());
				...
				if (person.getDisappearMan() != null) {
					...
					dataList.add(person.getDisappearMan().getUnitContactTelphone());
					dataList.add(person.getDisappearMan().getReportContactName());
					dataList.add(person.getDisappearMan().getReportContactTelphone());
					dataList.add(person.getDisappearMan().getCurrentAddress());
					dataList.add(person.getDisappearMan().getMissingAddress());
					dataList.add(person.getDisappearMan().getMissingStartTime());
					dataList.add(person.getDisappearMan().getFoundMissingTime());
					...
					dataList.add(person.getDisappearMan().getSpecificFeatureCon());
				...
				dataList.add("失踪人员");
				dataList.add(person.getJoinDate()==null?"":person.getJoinDate());
			...
			// "人员编号","姓名","性别","出生日期","办案单位","办案人", "QQ","微信号","身份证号","手机号码","户籍地详址","户籍地区划","DNA编号","其他身份信息","指纹编号","足迹编号","现住地区划","现住地详址","虚拟身份","银行卡信息","绰号","车牌号","发动机号","车架号","手机串号","人员备注信息","携带物品","携带工具","人员分类","录入时间"
