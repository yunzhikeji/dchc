...
<html>
	...
	<body>
		<div class="pd-20">
			<form  method="post" class="form form-horizontal" id="form-article-add"  onsubmit="">
				<div class="row cl">
					<div class="row cl">
					...
					<div class="formControls col-3">
						<s:textfield id="title" name="successexample.number" readonly="true"
					...
					<div class="row cl">
						...
						<div class="formControls col-3">
							<s:textfield id="author" name="successexample.releaseName"  readonly="true"
							cssClass="input-text radius size-M " cssStyle="width: 200px;"></s:textfield>
						</div>
						<label class="form-label col-2">
							上报时间：
						...
						<div class="formControls col-3">
							<input type="text" name="successexample.releaseTime" readonly="true"  style="width: 200px;" value="${successexample.releaseTime}"
					...
					<div class="row cl">
						...
						<span class="formControls col-10">
									<s:textarea name="successexample.content" readonly="true"
