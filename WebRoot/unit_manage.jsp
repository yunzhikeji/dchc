					...
					<table width="98%" border="0" align="center" cellpadding="2"
						...
						<tr align="right" bgcolor="#EEF4EA">
							...
							<td height="34" colspan="6" align="center" bgcolor="#FFFFFF">
								  <a href="javascript:jumpCommonPage('unitAction!list',1,<s:property value="con"/>,'<s:property value="convalue"/>');" >首页</a>&nbsp;&nbsp; 
  								  <a href="javascript:jumpCommonPage('unitAction!list',<s:property value="page-1"/>,<s:property value="con"/>,'<s:property value="convalue"/>');" >上一页</a>&nbsp;&nbsp;&nbsp; 
  								  <a href="javascript:jumpCommonPage('unitAction!list',<s:property value="page+1"/>,<s:property value="con"/>,'<s:property value="convalue"/>');" >下一页</a>&nbsp;&nbsp;&nbsp; 
  							      <a href="javascript:jumpCommonPage('unitAction!list',<s:property value="pageCount"/>,<s:property value="con"/>,'<s:property value="convalue"/>');" >尾页</a>&nbsp;&nbsp;&nbsp;
