...
<html>
	...
	<body>
		...
		<div class="pd-20">
			<div class="text-c">
				<form name="gamblingCriminalManListForm" method="post" action="gamblingCriminalManAction!list"
					target="_self">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20">
					<span class="l"><a href="javascript:;" onclick="deleteAllCheckedPersons();"
						...
						onclick="childPageFull('新增<s:property value="pageTileName"/>','gamblingCriminalManAction!goToAdd?type=<s:property value="type"/>')" href="javascript:;"><i
			...
			<table class="table table-border table-bordered table-hover table-bg">
				...
				<tbody>
					<s:iterator value="gamblingCriminalMans" var="gamblingCriminalMan" status="status">
							<tr class="text-c va-m">
								...
								<td>
									<a style="text-decoration: none" class="ml-5"
										onclick="childPageFull('查看人员','gamblingCriminalManAction!view?id=<s:property value="id"/>')"
										href="javascript:;" title="查看"><s:property value="person.name" /></a>
								</td>
								<td>
									赌博人员
								</td>
								<td>
									<s:property value="person.userRole.unit.name" />
								</td>
								<td>
									<s:property value="person.userRole.realname" />
								</td>
								<td>
									<s:property value="person.joinDate" />
								</td>
								<td>
									<s:if test="person.handleState==0">未办理</s:if>
									<s:if test="person.handleState==1">未办理</s:if>
									<s:if test="person.handleState==2">已办理</s:if>
									<s:if test="person.handleState==3">已完结</s:if>
									
								</td>
								<td class="td-manage">
									<a style="text-decoration: none" class="ml-5"
										onclick="childPageFull('编辑人员','gamblingCriminalManAction!load?id=<s:property value="id"/>&type=<s:property value="type" />')"
										href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i>
									</a>
									<a style="text-decoration: none" class="ml-5"
										href="gamblingCriminalManAction!delete?id=<s:property value="id" />&type=<s:property value="type" />" onclick="return confirm('你确定删除该信息吗？')"
				...
				<table width="98%" border="0" align="center" cellpadding="2"
					...
					<tr align="right" bgcolor="#EEF4EA">
						...
						<td height="34" colspan="6" align="center" bgcolor="#FFFFFF">
							<a
								href="javascript:jumpPersonPage('gamblingCriminalManAction!list',1,<s:property value="con"/>,'<s:property value="convalue"/>',<s:property value="type"/>,<s:property value="queryState"/>,'<s:property value="starttime"/>','<s:property value="endtime"/>');"
								target="rightFrame">首页</a>&nbsp;&nbsp;
							<a
								href="javascript:jumpPersonPage('gamblingCriminalManAction!list',<s:property value="page-1"/>,<s:property value="con"/>,'<s:property value="convalue"/>',<s:property value="type"/>,<s:property value="queryState"/>,'<s:property value="starttime"/>','<s:property value="endtime"/>');"
								target="rightFrame">上一页</a>&nbsp;&nbsp;&nbsp;
							<a
								href="javascript:jumpPersonPage('gamblingCriminalManAction!list',<s:property value="page+1"/>,<s:property value="con"/>,'<s:property value="convalue"/>',<s:property value="type"/>,<s:property value="queryState"/>,'<s:property value="starttime"/>','<s:property value="endtime"/>');"
								target="rightFrame">下一页</a>&nbsp;&nbsp;&nbsp;
							<a
								href="javascript:jumpPersonPage('gamblingCriminalManAction!list',<s:property value="pageCount"/>,<s:property value="con"/>,'<s:property value="convalue"/>',<s:property value="type"/>,<s:property value="queryState"/>,'<s:property value="starttime"/>','<s:property value="endtime"/>');"
								target="rightFrame">尾页</a>&nbsp;&nbsp;&nbsp;
							<input type='button' class="btn btn-primary radius size-S"
								onclick="jumpPersonPage('gamblingCriminalManAction!list',document.getElementById('page').value,<s:property value="con"/>,'<s:property value="convalue"/>',<s:property value="type"/>,<s:property value="queryState"/>,'<s:property value="starttime"/>','<s:property value="endtime"/>');"
								value='转到' />
							&nbsp; 当前页：
