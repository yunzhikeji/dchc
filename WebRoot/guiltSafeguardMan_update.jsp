...
<form name="personAddForm" action="personAction!update" method="post"
    ...
    <div class="pd-20">
                ...
                <div class="tabCon">
                    ...
                    <div class="row cl mt-20">
                        <div class="col-12 mb-0 c-primary f-16"
                            ...
                            <input class="btn btn-primary radius mt-10 f-r" type="button"
                                   onclick="addPage('新增关系人','otherpersonAction!goToAdd?pid=<s:property
                                           value="id"/>&otype=1','500','300')"
                                   value="新增关系人">
                        </div>
                        <div class="col-12">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a style="text-decoration: none" class="ml-5"
                                                   onclick="addPage('编辑同案人','otherpersonAction!load?otherid=<s:property
                                                           value="id"/>','500','300')"
                    ...
                    <div class="row cl mt-20">
                        <div class="col-12 mb-0 c-primary f-16"
                            ...
                            同案人员信息
                            <input class="btn btn-primary radius mt-10 f-r" type="button"
                                   onclick="addPage('新增同案人员','otherpersonAction!goToAdd?pid=<s:property
        ...
        <s:hidden name="guiltSafeguardMan.criminalRecordPhoto1"
                  title="前科照片1"></s:hidden>
        <s:hidden name="guiltSafeguardMan.criminalRecordPhoto2"
                  title="前科照片2"></s:hidden>
        <s:hidden name="guiltSafeguardMan.criminalRecordPhoto3"
                  title="前科照片3"></s:hidden>
