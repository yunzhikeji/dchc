				...
				<table width="98%" border="0" align="center" cellpadding="2"
					...
					<tr align="right" bgcolor="#EEF4EA">
						...
						<td height="34" colspan="6" align="center" bgcolor="#FFFFFF">
							...
							&nbsp;&nbsp;&nbsp;
							<a href="javascript:jumpDevlogPage('devlogAction!list',<s:property
									value="1" />,<s:property value="sigid" />,'<s:property
									value="devevent" />','<s:property value="startdate" />','<s:property
									value="enddate" />');"
								target="main">首页</a>&nbsp;&nbsp;
							<a
								href="javascript:jumpDevlogPage('devlogAction!list',<s:property
									value="page-1" />,<s:property value="sigid" />,'<s:property
									value="devevent" />','<s:property value="startdate" />','<s:property
									value="enddate" />');"
								target="main">上一页</a>&nbsp;&nbsp;&nbsp;
							<a
							...
							<a
								href="javascript:jumpDevlogPage('devlogAction!list',<s:property
									value="pageCount" />,<s:property value="sigid" />,'<s:property
									value="devevent" />','<s:property value="startdate" />','<s:property
									value="enddate" />');"
								target="main">尾页</a>&nbsp;&nbsp;&nbsp;
							<input type='button' class="btn btn-primary radius size-S" onclick="jumpDevlogPage('devlogAction!list',document.getElementById('page').value,<s:property value="sigid" />
							,'
