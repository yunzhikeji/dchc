						...
						<div class="tabCon">
							<div class="row cl text-c">
								<h1 style="line-height: 80px;">
									<small style="color: #000;">线索流转</small>
								</h1>
							</div>
							...
							<div class="row cl">
								...
								<div class="row cl mb-10">
									...
									<div class="col-4">
										<s:textfield name="commonClue.virtualId"
											cssClass="input-text radius size-M " cssStyle="width: 200px;"></s:textfield>
									</div>
									<div class="col-2">
										<label class="form-label text-r">
									...
									<div class="col-4">
										<s:textfield name="commonClue.bankCard"
											cssClass="input-text radius size-M " cssStyle="width: 200px;"></s:textfield>
									</div>
								</div>
								<div class="row cl mb-10">
									...
									<div class="col-10">
										<s:textarea name="commonClue.askHelpContent"
											...
											<tr>
												<td align="center">
													...
													<img id="myimage1" class="img-responsive thumbnail"
														width="200px" height="180px;" alt="添加户籍照片" />
											...
											<tr>
												<td align="center">
													<img id="myimage2" class="img-responsive thumbnail"
														width="200px" height="180px;" alt="添加前科照片" />
													<script type="text/javascript">
															function change2() {
