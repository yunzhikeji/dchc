		...
		<div class="pd-20">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr height="35">
							<td width="21%" align="right" style="padding-right: 50px;">
								<s:select
									list="#{0:'选择类型',1:'线索名称',2:'线索编号',3:'线索情报类型',4:'录入人员姓名'}"
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20">
					<span class="l"><a href="javascript:;" onclick="deleteAllCheckedPersons();"
						...
						onclick="childPageFull('新增<s:property value="pageTileName"/>','clueAction!goToAdd?type=<s:property value="type"/>')" href="javascript:;"><i
							...
							<tr class="text-c va-m">
								...
								<td>
									<a style="text-decoration: none" class="ml-5"
										onclick="childPageFull('查看人员','clueAction!view?id=<s:property value="id"/>')"
								...
								<td class="td-manage">
									<a style="text-decoration: none" class="ml-5"
										onclick="childPageFull('编辑人员','clueAction!load?id=<s:property value="id"/>&type=<s:property value="type" />')"
										href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i>
									</a>
									<a style="text-decoration: none" class="ml-5"
										href="clueAction!delete?id=<s:property value="id" />&type=<s:property value="type" />" onclick="return confirm('你确定删除该信息吗？')"
