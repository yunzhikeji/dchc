							...
							<div class="row cl">
								<table width="100%" border="0" cellspacing="0" cellpadding="0"
									...
									<tr>
										...
										<td>
											<s:select
												list="#{0:'请选择',1:'研究生',2:'研究生毕业',3:'研究生肄业',4:'大学本科',5:'大学毕业',6:'相当大学毕业',7:'大学肄业',8:'大学专科',9:'专科毕业',10:'相当专科毕业',11:'专科肄业',12:'中专或中技',13:'中专毕业',14:'中技毕业',15:'相当中专或中技毕业',16:'中专或中技肄业',17:'技工学校',18:'技工学校毕业',19:'技工学校肄业',20:'高中',21:'高中毕业',22:'职业高中毕业',23:'农业高中毕业',24:'相当高中毕业',25:'高中肄业',26:'初中',27:'初中毕业',28:'职业初中毕业',29:'农业初中毕业',30:'相当初中毕业',31:'初中肄业',32:'小学',33:'小学毕业',34:'相当小学毕业',35:'小学肄业',36:'文盲或半文盲',37:'博士',38:'博士后'}"
												cssClass="input-text" name="analyzeMan.degreeEducation"
												listKey="key" listValue="value" cssStyle="width:180px"></s:select>
										</td>
										<td width="14%">
											<label class="form-label text-r">
										...
										<td width="23%">
											<s:select
												list="#{0:'请选择',1:'汉族',2:'蒙古族',3:'回族',4:'藏族',5:'维吾尔族',6:'苗族',7:'彝族',8:'壮族',9:'布依族',10:'朝鲜族',11:'满族',12:'侗族',13:'瑶族',14:'白族',15:'土家族',16:'哈尼族',17:'哈萨克族',18:'傣族',19:'黎族',20:'傈僳族',21:'佤族',22:'畲族',23:'高山族',24:'拉祜族',25:'水族',26:'东乡族',27:'纳西族',28:'景颇族',29:'柯尔克孜族',30:'土族',31:'达斡尔族',32:'仫佬族',33:'羌族',34:'布朗族',35:'撒拉族',36:'毛难族',37:'仡佬族',38:'锡伯族',39:'阿昌族',40:'普米族',41:'塔吉克族',42:'怒族',43:'乌孜别克族',44:'俄罗斯族',45:'鄂温克族',46:'崩龙族',47:'保安族',48:'裕固族',49:'京族',50:'塔塔尔族',51:'独龙族',52:'鄂伦春族',53:'赫哲族',54:'门巴族',55:'珞巴族',56:'基诺族',57:'其他',58:'外国血统中国籍'}"
												cssClass="input-text" name="analyzeMan.nationality"
									...
									<tr>
										...
										<td>
											<s:select list="#{0:'请选择',1:'盗窃',2:'抢劫',3:'抢夺',4:'其它',5:'无'}"
												cssClass="input-text" name="analyzeMan.criminalRecord"
												listKey="key" listValue="value" cssStyle="width:180px"></s:select>
											<s:textfield name="analyzeMan.criminalRecordTimes"
												cssClass="input-text radius size-M " cssStyle="width: 50px;"></s:textfield>
											次
										</td>
										<td>
											<label class="form-label text-r">
									...
									<tr>
										...
										<td>
											<s:select list="#{0:'请选择',1:'固定职业',2:'临时工',3:'无业'}"
									...
									<tr>
										...
										<td colspan="5">
											暂住证有无
											<s:select list="#{0:'请选择',1:'有',2:'无'}" cssClass="input-text"
												name="analyzeMan.haveTemporaryResidential" listKey="key"
												listValue="value" cssStyle="width:180px"></s:select>
											是否失效
											<s:select list="#{0:'请选择',1:'是',2:'否'}" cssClass="input-text"
												name="analyzeMan.isTemporaryResidentialUseful" listKey="key"
												listValue="value" cssStyle="width:180px"></s:select>
										</td>
									</tr>
									<tr>
										...
										<td colspan="3">
											<s:select list="#{0:'请选择',1:'七天',2:'一个月',3:'半年',4:'半年以上'}"
									...
									<tr>
										...
										<td colspan="5">
											有无登记
											<s:select list="#{0:'请选择',1:'有',2:'无'}" cssClass="input-text"
												name="analyzeMan.isStayRegister" listKey="key"
												listValue="value" cssStyle="width:180px"></s:select>
											有无未实名登记情况
											<s:select list="#{0:'请选择',1:'有',2:'无'}" cssClass="input-text"
												name="analyzeMan.isStayRealname" listKey="key"
												listValue="value" cssStyle="width:180px"></s:select>
											有无同住
											<s:select list="#{0:'请选择',1:'有',2:'无'}" cssClass="input-text"
												name="analyzeMan.isStayInmate" listKey="key"
												listValue="value" cssStyle="width:180px"></s:select>
										</td>
									</tr>
									<tr>
										...
										<td colspan="5">
											有无登记
											<s:select list="#{0:'请选择',1:'有',2:'无'}" cssClass="input-text"
												name="analyzeMan.isNetplayRegister" listKey="key"
												listValue="value" cssStyle="width:180px"></s:select>
											有无未实名登记情况
											<s:select list="#{0:'请选择',1:'有',2:'无'}" cssClass="input-text"
												name="analyzeMan.isNetplayRealname" listKey="key"
												listValue="value" cssStyle="width:180px"></s:select>
											是否案发地附近
											<s:select list="#{0:'请选择',1:'是',2:'否'}" cssClass="input-text"
												name="analyzeMan.isCaseHappenNearbyInternetbar"
												listKey="key" listValue="value" cssStyle="width:180px"></s:select>
										</td>
									</tr>
									<tr>
										...
										<td>
											<s:select list="#{0:'请选择',1:'务工',2:'经商',3:'亲朋资助',4:'无'}"
										...
										<td colspan="3">
											<s:select list="#{0:'请选择',1:'是',2:'否'}" cssClass="input-text"
												name="analyzeMan.isPropertyCrime" listKey="key"
												listValue="value" cssStyle="width:180px"></s:select>
										</td>
									</tr>
									<tr>
							...
							<div class="row cl mt-20">
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0"
									...
									<tr>
										...
										<td width="22%">
											<s:select list="#{0:'请选择',1:'是',2:'否'}" cssClass="input-text"
												name="analyzeMan.isStreetCrime" listKey="key"
												listValue="value" cssStyle="width:180px"></s:select>
										</td>
										<td colspan="2">
											<label class="form-label text-r">
										...
										<td colspan="2">
											<s:select list="#{0:'请选择',1:'是',2:'否'}" cssClass="input-text"
												name="analyzeMan.isSomeZone" listKey="key" listValue="value"
									...
									<tr>
										...
										<td colspan="2">
											...
											<s:select
												...
												cssClass="input-text"
												name="analyzeMan.transportationTypeCome" listKey="key"
												listValue="value" cssStyle="width:180px"></s:select>
											去
											<s:select
												list="#{0:'请选择',1:'徒步',2:'公交车',3:'黄鱼车',4:'私家车',5:'私家车',6:'公共自行车',7:'地铁'}"
									...
									<tr>
										...
										<td>
											<s:select list="#{0:'请选择',1:'是',2:'否'}" cssClass="input-text"
												name="analyzeMan.isGangCrime" listKey="key"
												listValue="value" cssStyle="width:180px"></s:select>
										</td>
										<td width="14%">
											<label class="form-label text-r">
										...
										<td width="17%">
											<s:select
												...
												cssClass="input-text" name="analyzeMan.gangGx" listKey="key"
												listValue="value" cssStyle="width:180px"></s:select>
										</td>
										<td width="14%">
											<label class="form-label text-r">
										...
										<td width="23%">
											<s:select list="#{0:'请选择',1:'2人',2:'3-7人',3:'8人以上'}"
									...
									<tr>
										...
										<td>
											<s:select list="#{0:'请选择',1:'网购',2:'商购',3:'自制',4:'他人给予'}"
										...
										<td>
											<s:select
												list="#{0:'请选择',1:'本地',2:'跨社区',3:'跨街道',4:'跨区县',5:'跨市',6:'跨省'}"
												cssClass="input-text" name="analyzeMan.foulTo" listKey="key"
												listValue="value" cssStyle="width:180px"></s:select>
										</td>
										<td>
											<label class="form-label text-r">
										...
										<td>
											<s:select list="#{0:'请选择',1:'卖',2:'典当',3:'散卖',4:'自用',5:'转送'}"
