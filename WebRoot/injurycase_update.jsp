...
<body>
<form name="injurycaseUpdateForm" action="injurycaseAction!update"
                ...
                <s:if
                    ...
                    <div class=" f-r pr-5">
                        <button type="button" class="btn btn-success radius"
                                name=""
                                onclick="addPage('发布案例','successexampleAction!goToAdd?inid=<s:property
                                        value="id"/>','500','300')">
                        ...
                        <div class="row cl mb-10">
                            ...
                            <div class="col-4">
                                <s:textfield id="crimePattern" name="injurycase.crimePattern"
                                             ...
                                             readonly="true" onclick="showMenu(this);"></s:textfield>
                        ...
                        <div class="row cl mt-20">
                            <div class="col-12 mb-0 c-primary f-16"
                                ...
                                <input class="btn btn-primary radius mt-10 f-r" type="button"
                                       ...
                                       onclick="addPage('新增图片','mediaAction!goToAdd?inid=<s:property
                                               value="id"/>&mtype=0','500','300')"
                                       value="新增图片">

                                <input class="btn btn-primary radius mt-10 f-r" type="button"
                                       onclick="addPage('查看所有图片','mediaAction!goToViewMedias?inid=<s:property
                                               value="id"/>&mtype=0','500','300')"
                                       value="查看所有图片">
                            </div>
                            <div class="col-12">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a style="text-decoration: none" class="ml-5"
                                                       onclick="addPage('编辑图片','mediaAction!load?mid=<s:property
                                                               value="id"/>','500','300')"
                                                       href="javascript:;" title="编辑"><i
                                                            class="Hui-iconfont">&#xe6df;</i> </a>
                                                    <a style="text-decoration: none" class="ml-5"
                                                       href="<s:property value="src" />" title="查看">查看</a>
                                                    <a style="text-decoration: none" class="ml-5"
                                                       href="javascript:;"
                            ...
                            <div class="row cl mt-20">
                                <div class="col-12 mb-0 c-primary f-16"
                                    ...
                                    上传视频信息
                                    <input class="btn btn-primary radius mt-10 f-r" type="button"
                                           onclick="addPage('新增视频','mediaAction!goToAdd?inid=<s:property
                                                   value="id"/>&mtype=1','500','300')"
                                           value="新增视频">
                                </div>
                                <div class="col-12">
                                    <table class="table table-border table-bg">
                                        ...
                                        <tbody>
                                        <s:if test="mediaVideos.size>0">
                                            <s:iterator value="mediaVideos" var="media"
                                                        status="status">
                                                <tr>
                                                    <td>
                                                        <s:property value="#status.index+1"/>
                                                    ...
                                                    <td>
                                                        <a
                                                                href="mediaAction!view?mid=<s:property value="id" />"
                                                                onclick="javascript:void(0)"> <s:property
                                                                value="title"/> </a>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <a style="text-decoration: none" class="ml-5"
                                                           onclick="addPage('编辑视频','mediaAction!load?mid=<s:property
                                                                   value="id"/>','500','300')"
                                                           href="javascript:;" title="编辑"><i
                                                                class="Hui-iconfont">&#xe6df;</i> </a>
                                                        <a style="text-decoration: none" class="ml-5"
                                ...
                                <div class="row cl mt-20">
                                    <div class="col-12 mb-0 c-primary f-16"
                                        ...
                                        <input class="btn btn-primary radius mt-10 f-r"
                                               type="button"
                                               onclick="addPage('新增嫌疑人员','otherpersonAction!goToAdd?inid=<s:property
                                                       value="id"/>&otype=2','500','300')"
                                               value="新增嫌疑人员">
                                    </div>
                                    <div class="col-12">
                                        <table class="table table-border table-bg">
                                                    ...
                                                    <s:iterator value="injurycase.troubleshootings"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a style="text-decoration: none" class="ml-5"
                                                                   href="javascript:;"
                                                                   onclick="deleteTroubleshooting(<s:property
                                                                           value="id"/>);"
