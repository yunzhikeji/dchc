    ...
    <ul class="ce">
          ...
          <li><a href="#"><i class="Hui-iconfont ">&#xe636;</i> 案件管理<img class="more" src="images/more.png"/></a>
			   <ul class="er">
				 ...
				 <li><a _href="injurycaseAction!chainingCase" href="javascript:void(0)">串并案</a></li>
			   </ul>
		  </li>          
  ...
  <div id="Hui-tabNav" class="Hui-tabNav">
    <div class="Hui-tabNav-wp">
      <ul id="min_title_list" class="acrossTab cl">
        <li class="active"><span title="我的桌面" data-href="userRoleAction!welcome">我的桌面</span><em></em></li>
      </ul>
    </div>
