...
<html>
	...
	<body class="pos-r">
		<div>
			...
			<div class="pd-20">
				<div class="text-c">
					<form name="userRoleListForm" method="post" action="userRoleAction!list" target="_self">
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							style="line-height: 35px;">
							<tr height="35">
								<td width="21%" align="right" style="padding-right: 50px;">
									<s:select list="#{0:'选择类型',1:'所属机构',2:'姓名',3:'警号'}"
				...
				<div class="cl pd-5 bg-1 bk-gray mt-20">
					<span class="l"><a href="javascript:;" onclick="deleteAllCheckedUserRoles();"
						class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i>
							批量删除</a> <a class="btn btn-primary radius"
						onclick="childPage('添加角色','userRoleAction!goToAdd')" href="javascript:;"><i
				...
				<table
					...
					<tbody>
						...
						<s:iterator value="userRoles" var="userRole" status="status">
							<tr class="text-c va-m">
								...
								<td class="td-manage">
									<a style="text-decoration: none" class="ml-5"
										onclick="childPage('编辑角色','userRoleAction!load?id=<s:property value="id"/>')"
										href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i>
									</a>
									<a style="text-decoration: none" class="ml-5"
										href="userRoleAction!delete?id=<s:property value="id" />" onclick="return confirm('你确定删除该用户吗？')"
