        ...
        <div class="row cl">
            <div class="col-12 mb-0 c-primary f-16"
                ...
                <input class="btn btn-primary radius mt-10 f-r" type="button"
                       onclick="addPage('新增文件','mediaAction!goToAdd?jid=<s:property
                               value="judge.id"/>&mtype=3','500','300')"
                       value="新增文件">
            </div>
            <div class="col-12">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a style="text-decoration: none" class="ml-5"
                                       onclick="addPage('编辑文件','mediaAction!load?mid=<s:property
                                               value="id"/>','300','200')"
                                    ...
                                    <a href="<s:property value="src" />"><span>下载</span> </a>
